...
let favColor = ["Black", "Red", "Brown", "Blue", "Grey", "White"];

let s = "Hello World"

console.log(s.length) //outputs the number of characters in a string which begin with the number 1
...
fruits[4] = "Mango" //Adds an item to the right hand side of the fruit array
// fruits.push("Mango")
console.log(fruits);
...
console.log(`The time is ${theHr}:${theMins}:${theSecs}`);
}
